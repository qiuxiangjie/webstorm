...
$(function () {
    ...
    console.log(contractProvince,contractCity,contractDistrict);
...
/*            selectProvince(contractProvince);
    ...
    var myIcon = new BMap.Icon("./images/dingwei_02.png", new BMap.Size(300,157));
    var prevID='',mapData,allOverlay,projectId;
    var pointerData = [];

    function mapSearch (cityName,ser){
        //var url = 'http://192.168.251.130:8080/dms/project/address/searchMap.do?city='+cityName+'&q='+ser+'&pageSize=6&curPage=1';
    ...
    * */
    ...
    function changeColor (map,id){
        map.removeOverlay(allOverlay[id+1]);//删除点击的标注
        showPointInMap(map,mapData[id].longitude,mapData[id].latitude,id,selectedIcon);//创建新的标注并更换颜色
        if(prevID !== ''){
