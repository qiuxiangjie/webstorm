...
;(function(factory) {
    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        var init = function(update) {
            ...
            datepicker.
                delegate('td:not(.dp_disabled, .dp_weekend_disabled, .dp_not_in_month, .dp_week_number_disabled)', 'mouseover', function() {
                    $(this).addClass('dp_hover');
                }).
                delegate('td:not(.dp_disabled, .dp_weekend_disabled, .dp_not_in_month, .dp_week_number_disabled)', 'mouseout', function() {
                    $(this).removeClass('dp_hover');
                });
            ...
            daypicker.delegate('td:not(.dp_disabled, .dp_weekend_disabled, .dp_not_in_month, .dp_week_number, .dp_week_number_disabled)', 'click', function() {
                ...
                else if (plugin.settings.show_week_number) {
                    if ($(($(this).siblings('.dp_week_number'))[0]).next().attr('class') == "dp_not_in_month") {
                        $element.val(format(new Date(selected_year, selected_month - 1, to_int($(($(this).siblings('.dp_week_number'))[0]).next().html()), 12, 0, 0)) + " -- " + format(new Date(selected_year, selected_month, to_int($(($(this).parent().find('td:last'))).html()), 12, 0, 0)));
                    } else if (!$(($(this).parent().find('.dp_weekend'))[1]).html()) {
                        $element.val(format(new Date(selected_year, selected_month, to_int($(($(this).siblings('.dp_week_number'))[0]).next().html()), 12, 0, 0)) + " -- " + format(new Date(selected_year, selected_month + 1, to_int($(($(this).siblings('.dp_not_in_month:last'))).html()), 12, 0, 0)));
                    }else {
                        $element.val(format(new Date(selected_year, selected_month, to_int($(($(this).siblings('.dp_week_number'))[0]).next().html()), 12, 0, 0)) + " -- " + format(new Date(selected_year, selected_month, to_int($(($(this).parent().find('td:last'))).html()), 12, 0, 0)));
                    }
                    plugin.hide();
                    $element.focus();
                } else {
            ...
            daypicker.delegate('td.dp_week_number', 'click', function() {
                ...
                //else select_date(selected_year, selected_month, to_int($(this).html()), 'days', $(this));
                  ...
                  //console.log($(($(this).siblings('.dp_weekend'))[1]).html());
                    if ($($(this).next()).attr('class') == 'dp_not_in_month' && $(($(this).siblings('.dp_weekend'))[0]).html()) {
                        $element.val(format(new Date(selected_year, selected_month - 1, to_int($(this).next().html()), 12, 0, 0)) + " -- " + format(new Date(selected_year, selected_month, to_int($(($(this).siblings('.dp_weekend'))[0]).html()), 12, 0, 0)));
                    } else if ($($(this).next()).attr('class') == 'dp_not_in_month' && !$(($(this).siblings('.dp_weekend'))[0]).html() && $(($(this).siblings('.dp_weekend_disabled'))[0]).html()) {
                        $element.val(format(new Date(selected_year, selected_month - 1, to_int($(this).next().html()), 12, 0, 0)) + " -- " + format(new Date(selected_year, selected_month, to_int($(($(this).siblings('.dp_weekend_disabled'))[0]).html()), 12, 0, 0)));
                    } else if (!$(($(this).siblings('.dp_weekend'))[0]).html()) {
                        $element.val(format(new Date(selected_year, selected_month + 1, to_int($(this).next().html()), 12, 0, 0)) + " -- " + format(new Date(selected_year, selected_month + 1, to_int($(($(this).siblings('.dp_not_in_month:last'))).html()), 12, 0, 0)));
                    } else if (!$(($(this).siblings('.dp_weekend'))[1]).html()){
                        $element.val(format(new Date(selected_year, selected_month, to_int($(this).next().html()), 12, 0, 0)) + " -- " + format(new Date(selected_year, selected_month + 1, to_int($(($(this).siblings('.dp_not_in_month:last'))).html()), 12, 0, 0)));
                    } else {
                        $element.val(format(new Date(selected_year, selected_month, to_int($(this).next().html()), 12, 0, 0)) + " -- " + format(new Date(selected_year, selected_month, to_int($(($(this).siblings('.dp_weekend'))[1]).html()), 12, 0, 0)));
                    }
                  //$element.val(format(new Date(selected_year, selected_month, to_int($(this).next().html()), 12, 0, 0)) + " -- " + format(new Date(selected_year, selected_month, to_int($(($(this).siblings('.dp_weekend'))[1]).html()), 12, 0, 0)));
                  //$element.val(format(new Date(selected_year, selected_month, to_int($(this).next().html()), 12, 0, 0)));
                  plugin.hide();
                  $element.focus();
                }
            });
        ...
        var generate_daypicker = function() {
            ...
            for (i = 0; i < 42; i++) {
                ...
                if (i % 7 === 0 && plugin.settings.show_week_number) {
                    if (Date.parse(reference_date) > Date.parse(new Date(selected_year, selected_month, (i - days_from_previous_month + 1)))) {
                        html += '<td class="dp_week_number">' + getWeekNumber(new Date(selected_year, selected_month, (i - days_from_previous_month + 1))) + '</td>';
                    } else {
                        html += '<td class="dp_week_number_disabled">' + getWeekNumber(new Date(selected_year, selected_month, (i - days_from_previous_month + 1))) + '</td>';
                    }
            ...
            if (plugin.settings.always_visible)
                ...
                daypicker_cells = $('td:not(.dp_disabled, .dp_weekend_disabled, .dp_not_in_month, .dp_week_number, .dp_week_number_disabled)', daypicker);
        ...
        var select_date = function(year, month, day, view, cell) {
            ...
            if (view == 'months') {
                var monthDate = default_date.getFullYear() + '-';
                if (default_date.getMonth() < 9) {
                    monthDate += '0' + (default_date.getMonth() + 1);
                    //monthDate += '0' + (default_date.getMonth() + 1) + '-01';
                } else {
                    monthDate += (default_date.getMonth() + 1);
                    //monthDate += (default_date.getMonth() + 1) + '-01';
                }
                $element.val(monthDate);
            } else {
