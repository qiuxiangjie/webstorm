 ...
 * @LastEditTime: 2021-07-09 18:27:28
 * @Copyright: 2020 cheworld.com Inc. All rights reserved. 版权所有
 * 深圳市万普合信科技有限公司（91440300MA5FUB0P88） 注意：仅限于公司内部传阅，禁止外泄以及用于其他的商业目的
 */
let dataJson = {
  "nodes": [
    {"id": "0", "label": "n0", "class": "c0","x": 1000, "y": -100,"type": 'circle-animate', },
    {"id": "1", "label": "n1", "class": "c0","x": 300, "y": -10 , 'type': 'inner-animate',size: [40, 40],'img':
    ...
    {"id": "2", "label": "n2", "class": "c0","x": 10, "y": 10 ,"type": 'background-animate'},
  ...
  "edges": [
    ...
    {"source": "0", "target": "13", "label": "e0-13", "weight": 3 },
